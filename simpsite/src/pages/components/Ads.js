...
const Ads = () => {
    return (
        <div className='w-full bg-zinc-800 py-16 px-4 text-white'>
            <div className='max-w-[1240px mx-auto grid md:grid-cols-2'>
                ...
                <div className='flex flex-col items-center justify-center'>
                    <button className='bg-indigo-300 w-[200px] rounded-md font-bold my-6 mx-auto py-3 text-black'>Get Started For Free</button>
                    <img className='w-[500px] mx-auto my-4' src='/shorten.png' alt='/' /></div>
            </div>
        </div>
    )
}
